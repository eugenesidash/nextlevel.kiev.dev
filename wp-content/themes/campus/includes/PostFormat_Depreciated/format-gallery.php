<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?>>	
	...
	<?php // ODD FIX FOR DOUBLE GALLERY POST ON SINGLE TEMPLATE
	if ( !is_single() ) : ?>
	...
	if ( is_single() ) : ?>
		...
		<div class="entry-content">
			<?php //the_content(); //Seems to result in double content. ?>
		</div>
	...
	<div class="entry-meta"> 				
		<div class="meta-string">	
			<span class="format-icon"><i class="gen-enclosed foundicon-photo" title="Image Post"></i></span>
