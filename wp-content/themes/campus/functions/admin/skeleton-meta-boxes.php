...
function custom_meta_boxes() {
  ...
  $page_options = array(
	...
	array(
        ...
        'desc'        => 'This sets the height of the custom page image. This is useful if you want to contorl the height for this image, but do not want to use a page caption in this area. You can enter any px value. For example: "190px"',
        'std'         => '',
        'type'        => 'textarea-simple',
        'section'     => '',
        'rows'        => '1',
