...
array(
        ...
        'desc'        => 'This is where you will setup some basic typography options for the theme. Before you dive into any of the font-replacement stuff, start with a default font-stack and color based on the tone you want your website design to have. <br /><br />Then read the next set of instructions if you want to use Font-Replacement with Google Fonts or Typekit. 
        ',
        'type'        => 'textblock-titled',
        'section'     => 'typography',
        'rows'        => '',
      ...
      array(
       ...
       array( // Custom CSS Code INVISIBLE TO USERS
  			...
  			'section'     => 'typography',
  			'rows'		  => 12,
  			'std'		  => 'body, p, span, .sf-menu li a { {{body_font}} !important }
  h1 *,h2 *,h3 *,h4 *,h5 *, .tp-caption *{ {{headline_font}} !important}
  '
  		),
...
/* ---------------------------------------------------------*/
	array(
	  ...
	  array(
        ...
        'desc'        => 'Select "Yes" to display the author box at the bottom of blog posts. You can also control this from individual posts.',
        'std'         => '',
        'type'        => 'select',
        'section'     => 'footer',
        'rows'        => '',
...
<br /><hr /><br />
	    ...
	    <div style="text-align: center;"><a target="_blank" href="http://i.imgur.com/RUPCV9U.jpg?1"><img src="http://i.imgur.com/RUPCV9U.jpg?1" width="90%" /></a></div>
