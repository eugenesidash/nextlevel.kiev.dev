	...
	for ($i=1; $i<=9; $i+=2) {
		...
		if ( $parabolas["parabola_social$j"] ) {
			...
			class="socialicons social-<?php echo esc_attr($parabolas["parabola_social$i"]); ?>" title="<?php echo $parabolas["parabola_social_title$i"] !="" ? esc_attr($parabolas["parabola_social_title$i"]) : esc_attr($parabolas["parabola_social$i"]); ?>">
				<img alt="<?php echo esc_attr($parabolas["parabola_social$i"]); ?>" src="<?php echo get_template_directory_uri().'/images/socials/'.$parabolas["parabola_social$i"].'.png'; ?>" />
			</a><?php
		}
	}
	echo '</div>';
...
function parabola_breadcrumbs() {
	...
	if ( is_home() && ($parabolas['parabola_frontpage']!="Enable") ) {
...
function parabola_breadcrumbs2() {
	...
	elseif (is_home() && ($parabolas['parabola_frontpage']!="Enable") ) {
        // Front page
        echo '<div class="breadcrumbs">';
...
function parabola_copyright() {
	global $parabolas;
	echo '<div id="site-copyright">' . wp_kses_post( $parabolas['parabola_copyright'] ) . '</div>';
} // parabola_copyright()
