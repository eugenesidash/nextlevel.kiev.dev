			...
			<?php if ( have_posts() ) : ?>
				...
				<div id="author-info">
					...
					<div id="author-description">
						<h4><?php printf( __( 'About %s', 'parabola' ), get_the_author() ); ?></h4>
				...
				<?php if ( $parabolas['parabola_pagination']=="Enable" ) parabola_pagination(); else parabola_content_nav( 'nav-below' ); ?>
