...
function parabola_frontpage() {
	...
	<div id="frontpage">
		...
		if ( $parabolas['parabola_fronttext1'] ) {?><h2 id="front-text1"><?php echo esc_attr($parabolas['parabola_fronttext1']) ?> </h2><?php }
		...
		if ( $parabolas['parabola_fronttext2'] ) {?><h2 id="front-text2"><?php echo esc_attr($parabolas['parabola_fronttext2']) ?> </h2><?php }

		parabola_ppcolumns();

		// Frontpage text areas
		if ( $parabolas['parabola_fronttext3'] ) {?><div id="front-text3"><?php echo do_shortcode($parabolas['parabola_fronttext3']) ?></div><?php }
		if ( $parabolas['parabola_fronttext4'] ) {?><div id="front-text4"><?php echo do_shortcode($parabolas['parabola_fronttext4']) ?></div><?php }
		?>
	</div> <!-- frontpage --> <?php
