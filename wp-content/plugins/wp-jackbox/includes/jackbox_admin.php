	...
	function jackbox_admin() {
		...
		<div class="wrap jackbox-content jackbox-wrapper">
			...
			<form class="jackbox-form" method="post" action="options.php">
                ...
                <p>
					<?php _e("Always Show Page Scrollbar", "jackbox_domain"); ?> <span data-title="<?php _e("When set to 'yes', prevents the page from 'jumping' when entering and leaving the lightbox", "jackbox_domain"); ?>" class="jackbox-question">?</span><br />
					<span class="jackbox-box">
                ...
                <p>
					<?php _e("Use Keyboard Shortcuts", "jackbox_domain"); ?> <span data-title="<?php _e("Left/Right arrows change item, Esc key closes lightbox", "jackbox_domain"); ?>" class="jackbox-question">?</span><br />
					<span class="jackbox-box">
                ...
                <p>
					<?php _e("Mouse Click Loads Next Item", "jackbox_domain"); ?> <span data-title="<?php _e("Only available for images on desktops", "jackbox_domain"); ?>" class="jackbox-question">?</span><br />
					<span class="jackbox-box">
